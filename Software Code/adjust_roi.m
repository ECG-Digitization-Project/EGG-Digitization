...
if strcmp(app.Dropdown.Value, 'GE CASE V6.51')
    ref_image = rgb2gray(app.basefile.basefile_1) < (app.thresholdValue.Value-30); %app.thresholdContour{k};
elseif strcmp(app.Dropdown.Value, 'MAC500K 003A')
    ref_image = app.basefile.basefile_2 < (app.thresholdValue.Value-30); %app.thresholdContour{k};
end
